...
1. **返す順は辞書の並び。** → SPEC-ABBR-SEARCH-BY-NAME-009、SPEC-ABBR-SEARCH-BY-NAME-010
2. **全角・半角の吸収（`normalize`）。** → SPEC-ABBR-SEARCH-BY-NAME-011、SPEC-ABBR-SEARCH-BY-NAME-012
3. **filter.category と、filter の複数のキーの組み合わせ。** → SPEC-ABBR-SEARCH-BY-NAME-013、SPEC-ABBR-SEARCH-BY-NAME-014、SPEC-ABBR-SEARCH-BY-NAME-015
4. **`limit` の既定値と 1 未満の値。** → SPEC-ABBR-SEARCH-BY-NAME-016、SPEC-ABBR-SEARCH-BY-NAME-017、SPEC-ABBR-SEARCH-BY-NAME-018
